...
func TestCLI(t *testing.T) {
	var cases = []struct {
		...
		{strings.Split("tfdoc -l", " "),
			"", "Usage", 2},
		{strings.Split("tfdoc -l unknown", " "),
			"", "provider \"unknown\" is not found", 1},
		{strings.Split("tfdoc aws_instance", " "),
			"Provides an EC2 instance resource.", "", 0},
		{strings.Split("tfdoc unknown", " "),
			"", "resource \"unknown\" is invalid", 1},
		{strings.Split("tfdoc aws_unknown_resource", " "),
			"", "resource \"unknown\" is not found", 1},
